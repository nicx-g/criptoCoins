            ...
            <div class="ingresar-y-retirar-noCripto">
                ...
                <div class="ingresar-o-retirar-noCripto">
                    <div class="ingresar-o-retirar-noCripto-operacion">
                        <h2>¿Cuántos DAI's deseas retirar de tu cuenta?</h2>
                        <div class="ingresar-o-retirar-noCripto-input d-flex flex-column">
                            <label for="ingresarPesos">Insertar cantidad de DAI'S</label>
                            <input type="text" name="ingresarPesos" id="ingresarPesos" placeholder="Por ej: 35">
                        ...
                        <button type="submit">Enviar DAI's</button>
                    </div>
