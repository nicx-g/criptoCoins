                ...
                <div class="ingresar-o-retirar-noCripto">
                    <div class="ingresar-o-retirar-noCripto-operacion">
                        ...
                        <div class="ingresar-o-retirar-noCripto-input d-flex flex-column">
                            <label for="ingresarPesos">Insertar cantidad de Bitcoins</label>
                            <input type="text" name="ingresarPesos" id="ingresarPesos" placeholder="Por ej: 0.0130">
                        </div>
                        <button type="submit">Ingresar Bitcoins</button>
                    </div>

                    <div class="mensaje-de-operacion bg-light">
