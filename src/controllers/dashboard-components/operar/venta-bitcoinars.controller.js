        ...
        <div class="dashboard-content-operar">
            <div class="ingresar-y-retirar-noCripto">
                <div class="ingresar-o-retirar">
                    <a href="#/dashboard/operar/compra/bitcoinars">Comprar</a>
                    <a class="active-link" href="#/dashboard/operar/venta/bitcoinars">Vender</a>
                </div> 
                        ...
                        <form method="POST" id="form-compraventa" class="d-flex flex-column align-items-center">
                            <div class="ingresar-o-retirar-cripto-input d-flex">
                                <div class="d-flex align-items-center justify-content-center flex-column">
                                    <label for="moneyLeft">BTC que vas a vender</label>
            ...
            if (emailVerified){
                ...
                $(async()=>{
                    ...
                    moneyLeft.addEventListener('keyup', () => {
                      getCotizacion("ARS", "venta","left", "btcars", moneyLeft, moneyRight, cotizacionOperacion);  
                    }) 
                    moneyRight.addEventListener('keyup', () => {
                      getCotizacion("ARS", "venta", "right", "btcars", moneyLeft, moneyRight, cotizacionOperacion);  
                    }) 
                    ...
                    $(btnConfirmOperation).on('click', async (e) => {
                        ...
                        let respuestaALosFondos = await validarFondos(userEmail, "btc", moneyRight, moneyLeft);
                        ...
                        if(validaciones.fondos && validaciones.campoRelleno && validaciones.checked){
                            ...
                            await guardarOperacionDeCompraVenta(userEmail, moneyLeft, moneyRight, "venta", "btcars")
                            await guardarHistorialCompraVentaYCotizacion("ARS", userEmail, "venta", "btcars", moneyLeft);
